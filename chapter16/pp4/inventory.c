...
// Prompts the user to enter a part number.
// Prints an error message if the part doesn't exist; otherwise, prompts the user to enter a new price for the part and updates the database.
void update_price(void)
{
    int i, number;
    double price;
