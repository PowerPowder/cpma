...
// Repeatedly reads user guesses and tells the user whether eac hguess is too low, too
// high, or correct. When the guess is correct, prints the total number of guesses and returns.
