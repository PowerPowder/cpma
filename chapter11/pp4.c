...
// Reads the cards into the two arrays: num_in_rank and num_in_suit; checks for bad cards and depulicate cards.
void read_cards(int num_in_rank[], int num_in_suit[]);

/*
    Determines whether the hand contains a straight, a flush, four-of-a-kind, and/or three-of-a-kind;
    determines the number of pairs; stores the results into the pointer variables straight, flush,
